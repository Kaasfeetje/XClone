  ...
  return (
    <>
      ...
      <div className="w-full lg:flex lg:justify-center ">
        <div className="fixed top-0 w-full max-w-[1310px]">
          <div className="relative -left-3/4 h-screen w-3/4 bg-red-400 md:left-[25px] md:w-[60px] lg:left-[25px] lg:w-[275px]">
            SIDEBAR
          </div>
        </div>
        <main className="relative flex w-full justify-end lg:ml-[80px]  lg:max-w-[1310px]">
